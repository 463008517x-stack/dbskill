...
- `/dbs-xhs-title` 或 `/小红书标题` - 小红书标题公式工具
  - 75 个验证过的爆款公式（从 YAO《182 个小红书爆款标题清单》去重合并）
  - 12 类心理触发器分类（认知冲突、好奇缺口、恐惧损失、身份代入、数字锚定、结果承诺、社会证明、争议挑衅、场景条件、行动号召、权威借力、互动测试）
  - 每个公式附原始爆款举例 + 多行业定制举例
  - 10 条核心规则（含标题质量 5 条铁律：留悬念不说答案、话题扩大不缩窄、击中真实痛点、张力检查 6 选 2、≤20 字含标点）
